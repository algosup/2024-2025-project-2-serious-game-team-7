...
@export var countryColor : Color = Color.YELLOW_GREEN
@export var countryBorderColor : Color = Color.WHITE

@export var selected_countryColor : Color = Color.WHITE
@export var selected_countryBorderColor : Color = Color.RED
